...
- [ТЗ кейса](docs/TASK.md)
- [Политика использования данных](docs/DATA_POLICY.md)

## Внешние источники данных

Исходные данные турбин описаны в разделе «Данные и интеграции» выше. Внешние источники, которые команда планирует подключить:

| Источник | Что берём | Обучение | Прогноз (тест) | Статус |
| --- | --- | :---: | :---: | --- |
| Open-Meteo Previous Runs API | архивные прогнозы погоды, доступные на момент прогноза T | ✅ | ✅ | Планируется |

Гарантия отсутствия утечки данных: на этапе тестового прогноза используются только данные, опубликованные до момента прогноза T (issue time ≤ T). Подробнее — в [политике использования данных](docs/DATA_POLICY.md).
